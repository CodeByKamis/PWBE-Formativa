...
SECRET_KEY = 'django-insecure-!ex*7_8ny+^7rskx@n7e3==&4uo1$wk%q8c6*flagr)0pp+fom'
...
SIMPLE_JWT ={
    'ACESS_TOKEN_LIFETIME': timedelta(hours=4), #quando esse acabar o refresh gera um novo por mais 4 horas assim você não precisa relogar
    'REFRESH_TOKEN_LIFETIME': timedelta(days=2), #quando esse acaba vc tem que logar de novo
}
